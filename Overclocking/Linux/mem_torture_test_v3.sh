...
TEST_ID="APU26200MT_COCCX1-20_COCCX2-22_S1_O25_RUN1_ID7sj27r"

TOTAL_LOOP_TIME=120 PTS_CONCURRENT_TEST_RUNS=4 phoronix-test-suite stress-batch-run system/compress-7zip-1.0.0 pts/build-linux-kernel-1.16.0 pts/build-php-1.7.0 \
...
#     pts/opm-git-1.3.51 pts/qe-1.3.1 pts/qmcpack-1.8.0 pts/wrf-1.0.1
#
timeout 3 yes "${TEST_ID}" | phoronix-test-suite stress-batch-run pts/lapack pts/blas pts/compiler system/scientific
