...
timeout 30 yes "6000mt_pboe2_90_R4" | phoronix-test-suite batch-run system/compress-7zip-1.0.0 pts/build-linux-kernel-1.16.0 pts/build-php-1.7.0 \
...
timeout 30 yes "6000mt_pboe2_90_R4" | phoronix-test-suite stress-batch-run system/compress-7zip-1.0.0 pts/build-linux-kernel-1.16.0 pts/build-php-1.7.0 \
    pts/blender-4.3.0 pts/compress-7zip-1.11.0 pts/encode-flac-1.9.0 pts/mbw pts/stream \
    pts/hpcc-1.2.8 pts/hpl-1.0.0 pts/nwchem-1.2.0 \
    pts/opm-git-1.3.51 pts/qe-1.3.1 pts/qmcpack-1.8.0 pts/wrf-1.0.1

timeout 30 yes "6000mt_pboe2_90_R4" | phoronix-test-suite stress-batch-run pts/lapack pts/blas pts/compiler system/scientific
...
# for i in {1..600}; do
#     echo "===== Iteration $i ====="
#     timeout --preserve-status 1h ./p95*/mprime -t
#     ./y-cruncher*/y-cruncher bench 16G || timeout 2s speaker-test -t sine -f 1000
# done
